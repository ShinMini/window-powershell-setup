...
# Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser -> 권한이 없을 경우, 주석을 제거하고 실행해주세요
...
## make loading bar status(when starting updating) -> 업데이트를 시작할 때, 로딩바를 표시해주는 함수입니다.
for ($I = 1; $I -lt 101; $I++ ) {
